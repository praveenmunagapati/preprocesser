...
//will output "|float| |short| |char| |int|"
OUTPUT(" seq foreach call: \n", A3D_PP_FOREACH_ITEM(FOREACH_CALL, (int, char, short, float)));  

//will output "|1,2,-| |3,4,-| |A3D_PP_NULL,p,3, -| |0,A3D_PP_NULL,4, -| |1,1,4, -| |2,3,4, -|"
...
```c++
//expand (1,2,3) to (1,2,3,4,5)
OUTPUT("1. seq expand: \n", A3D_PP_EXPAND(A3D_PP_EXPAND((1, 2, 3), 4),5));

//unpack (1,2,3) to 1,2,3
OUTPUT("2. seq unpack: \n", A3D_PP_UNPACK((1, 2, 3)));

//compose (1,2) (3,4) to (1 3, 1 4, 2 3, 2 4)
...
//compose ги1,2) (3,4) (5,6) to (1 3 5, 1 3 6,...)
OUTPUT("6. seq compose 3: \n", A3D_PP_COMPOSE3((1, 2), (3, 4), (5,6) ));

//compose (unsigned, signed) (char, int) void to (void, unsigned char, unsigned int, signed int, signed char)
...
```
5. code generate, some meta-program help functions
```c++
